...
import com.mksolution.depressionreducer.databinding.ActivityMeditationBinding
        ...
        binding.startButton.setOnClickListener {
            ...
            countDownTimer = object : CountDownTimer(timerDuration, 1000L) {
                ...
                override fun onFinish() {
                    ...
                    binding.animationMaditation.cancelAnimation()
                    mediaPlayer?.stop()
                    mediaPlayer?.reset()
            ...
            mediaPlayer = MediaPlayer().apply {
                setDataSource(this@MeditationActivity, Uri.parse("android.resource://" + packageName + "/" + R.raw.love_ringtone))
                prepare()
                start()
            }
