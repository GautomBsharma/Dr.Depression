...
import com.mksolution.depressionreducer.databinding.ActivityMeditationThreeBinding

class MeditationThreeActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMeditationThreeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMeditationThreeBinding.inflate(layoutInflater)
