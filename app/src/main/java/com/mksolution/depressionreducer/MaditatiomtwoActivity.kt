...
import com.mksolution.depressionreducer.databinding.ActivityMaditatiomtwoBinding

class MaditatiomtwoActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMaditatiomtwoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMaditatiomtwoBinding.inflate(layoutInflater)
        setContentView(binding.root)

        mediaPlayer = MediaPlayer.create(this, R.raw.pianodropsrain)
